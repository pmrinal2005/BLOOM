...
export default function RightPanel({ onRegenerate }: { onRegenerate: () => void }) {
  ...
  const panelBorder = isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.09)';
  const headerTitleColor = isDark ? 'rgba(255,255,255,0.9)' : 'rgba(0,0,0,0.85)';
  const collapseTabBg = isDark ? 'rgba(0,220,255,0.08)' : 'rgba(0,160,200,0.1)';
  const collapseTabBorder = isDark ? 'rgba(0,220,255,0.22)' : 'rgba(0,160,200,0.3)';
  const collapseChevronColor = isDark ? '#00dcff' : '#0088aa';
  const headerBorderColor = isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.07)';
  ...
  const collapseBtnColor = isDark ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.6)';
  ...
  const dividerDotColor = isDark ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.25)';
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              width: 24, height: 56,
              background: collapseTabBg,
              border: `1px solid ${collapseTabBorder}`,
              borderRight: 'none',
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: headerTitleColor }}>
              Live Analysis
            </span>
          </div>
          <button
            ...
            style={{
              ...
              cursor: 'pointer', color: collapseBtnColor,
            }}
          >
